...
Main evaluation script for defect detection in SAGE.
This script loads experiment outputs and evaluates them against safety policies.
"""
...
from EvalChains.Misinformation import misinformation_chain
from EvalChains.SexualHarm import sexualharm_chain
from EvalChains.Violence import violence_chain
import time
import warnings
...
def main_wrapper(line, eval_chains):
    ...
    eval_chain = eval_chains[query["policy"]]
...
# Evaluate model outputs against safety policies
eval_chains = {
    "Misinformation": misinformation_chain,
    "Sexual Harm": sexualharm_chain,
